...
class Starting_menu():
      def __init__(self,game):
            ...
            for i in range(1,self.number_frame_attacking+1):
                  ...
                  self.image_attacking[i-1] = pygame.transform.scale(self.image_attacking[i-1],vec(self.image_attacking[i-1].get_size())*self.my_dict["RESIZE_FACTOR"]*2)
            ...
            for i in range(1,self.number_frame_reloading+1):
                  ...
                  self.image_reloading[i-1] = pygame.transform.scale(self.image_reloading[i-1],vec(self.image_reloading[i-1].get_size())*self.my_dict["RESIZE_FACTOR"]*2)
