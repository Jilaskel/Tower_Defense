...
ARCANE_TOWER_BUTTONS_TAG = [ARCANE_TOWER_LVL1_BUTTON_TAG,ARCANE_TOWER_LVL2_BUTTON_TAG,ARCANE_TOWER_LVL3_BUTTON_TAG]
FIRE_TOWER_LVL1_BUTTON_TAG = 4
FIRE_TOWER_LVL2_BUTTON_TAG = 5
FIRE_TOWER_LVL3_BUTTON_TAG = 6
FIRE_TOWER_BUTTONS_TAG = [FIRE_TOWER_LVL1_BUTTON_TAG,FIRE_TOWER_LVL2_BUTTON_TAG,FIRE_TOWER_LVL3_BUTTON_TAG]
LIGHTNING_TOWER_LVL1_BUTTON_TAG = 7
LIGHTNING_TOWER_LVL2_BUTTON_TAG = 8
LIGHTNING_TOWER_LVL3_BUTTON_TAG = 9
LIGHTNING_TOWER_BUTTONS_TAG = [LIGHTNING_TOWER_LVL1_BUTTON_TAG,LIGHTNING_TOWER_LVL2_BUTTON_TAG,LIGHTNING_TOWER_LVL3_BUTTON_TAG]
ICE_TOWER_LVL1_BUTTON_TAG = 10
ICE_TOWER_LVL2_BUTTON_TAG = 11
ICE_TOWER_LVL3_BUTTON_TAG = 12
ICE_TOWER_BUTTONS_TAG = [ICE_TOWER_LVL1_BUTTON_TAG,ICE_TOWER_LVL2_BUTTON_TAG,ICE_TOWER_LVL3_BUTTON_TAG]
