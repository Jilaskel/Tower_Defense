...
GOBELIN_WALKING_SIZE = [BACKGROUND_SQUARE_SIDE,BACKGROUND_SQUARE_SIDE] #   pixel
GOBELIN_NUMBER_FRAME_WALKING = 20
GOBELIN_ANIMATION_WALKING_TOTAL_TIME = 600 # in ms
GOBELIN_STOP_WALKING_FRAME = 11
 
GOBELIN_NUMBER_FRAME_TRANSITION  = 10
GOBELIN_TRANSITION_IMAGE_PATH = "Assets/Ennemies/Gobelin/TransitionAnim/"
GOBELIN_TRANSITION_SIZE = [BACKGROUND_SQUARE_SIDE,BACKGROUND_SQUARE_SIDE] #   pixel
...
GOBELIN_ATTACKING_SIZE = [BACKGROUND_SQUARE_SIDE,BACKGROUND_SQUARE_SIDE] #   pixel
