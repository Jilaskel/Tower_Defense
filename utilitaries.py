...
LIGHTNING_TOWER_ANIMATION_ATTACKING_TOTAL_TIME = 0
...
LIGHTNING_TOWER_ANIMATION_RELOADING_TOTAL_TIME = ARCANE_TOWER_ANIMATION_RELOADING_TOTAL_TIME*8
...
LIGHTNING_BOLT_RESIZE_FACTOR = 0.25*RESIZE_COEFF
LIGHTNING_BOLT_CENTOR_VECTOR = [0.5,0.0]

LIGHTNING_BOLT_DAMAGE = 60
LIGHTNING_NUMBER_BOUNCE_MAX = 3
LIGHTNING_DECREASING_DISTANCE_BOUNCE_FACTOR = 0.25  # will decrease of X% at each bounce
