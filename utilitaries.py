...
MOUSE_SIZE = [40.8* RESIZE_COEFF,50* RESIZE_COEFF]  #   pixel
...
OGRE_SIZE = [BACKGROUND_SQUARE_SIDE*1.5,BACKGROUND_SQUARE_SIDE*1.5] #   pixel
...
ARCANE_TOWER_SIZE = [BACKGROUND_SQUARE_SIDE*1.2,BACKGROUND_SQUARE_SIDE*1.2] #   pixel
ARCANE_TOWER_SCALE_FACTOR = 0.15
ARCANE_TOWER_CENTER_VECTOR = [0.5, 0.25]
ARCANE_TOWER_FIRING_OFFSET = [0,0]

ARCANE_TOWER_FIRING_PERIOD = 900 # in ms
ARCANE_TOWER_RANGE = 2.5 # multiplied by the image size
