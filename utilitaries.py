...
MENU_BALLISTA_BUTTON_IMAGE_PATH = "Assets/Tower/Baliste/AttackAnim/0001.png"
...
ARCANE_TOWER_NUMBER_FRAME_ATTACKING = 5
...
ARCANE_TOWER_NUMBER_FRAME_RELOADING = 5
ARCANE_TOWER_ANIMATION_RELOADING_TOTAL_TIME = 400

ARCANE_TOWER_OFFSET = [-0.9*BACKGROUND_SQUARE_SIDE,-1.2*BACKGROUND_SQUARE_SIDE] 
ARCANE_TOWER_RESIZE_FACTOR = 1.0*RESIZE_COEFF
ARCANE_TOWER_FIRING_OFFSET = [200* RESIZE_COEFF,150* RESIZE_COEFF]
# ARCANE_TOWER_FIRING_OFFSET = [0* RESIZE_COEFF,0* RESIZE_COEFF]
